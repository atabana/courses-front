...
describe('SessionListComponent', () => {
    ...
    describe('ngOnChanges', () =>{
        ...
        it('should filter sessions', () =>{
            ...
            sessionListComponent.sessions=<ISession[]>[{ name: 'course 1', level:'beginner'},
            { name: 'course 2', level:'beginner'},
            { name: 'course 3', level:'intermediate'}]
        ...
        it('should sort sessions', () =>{
            //arrange 
            sessionListComponent.sessions=<ISession[]>[{ name: 'course 2', level:'beginner'},
